...
do
{
	echo "document.getElementById('",$row91['Descr'],"').style.display="; echo'"none";'; echo"\n"; 
} while ( $row91 = $oDD->Getrow() );
?>
// this function toggles the status of a list 
function module(image,list){ 
...
5. Inventory<br />
This module is for managing all the stocks items that are in use by the registered organization. It contains several sub modules are shown below:
<ul class="menu">
